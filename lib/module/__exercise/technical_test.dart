...
class TechnicalTest {
  ...
  List list = [
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      DateTime output = new DateTime(2022, 1, 1);
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      DateTime output = new DateTime(2000, 12, 31);
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      DateTime output = new DateTime(1995, 9, 15);
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      DateTime output = new DateTime(2023, 5, 10);
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis jawabanmu di bawah ini
      DateTime output = new DateTime(2010, 11, 24);
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi 3
      output = Map<String, int>.from(input);
      // --- End of Answer ---
      return output.length == 3 &&
          output["apple"] == 2 &&
          output["cherry"] == 5;
    ...
    () {
      ...
      // Instruksi 3
      output = Map<String, double>.from(input);
      // --- End of Answer ---
      return output.length == 3 &&
          output["pi"] == 3.14 &&
          output["phi"] == 1.618;
...
// >>> Tulis jawabanmu di bawah ini
    ...
    () {
      ...
      // Instruksi 3
      output = input["isDiscounted"] == 1 ? true : null;
    ...
    () {
      ...
      Map<String, int>? output = {for (var fruit in fruits) fruit: 1};
      return output.length == 3;
    },
    // Exercise 179
    () {
      ...
      // Instruksi
      output = {
        for (var element in input.split(",")) int.parse(element): "value"
      };
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = {for (var number in input) number: number * number};
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.map((str) => {"length": str.length}).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.map((map) => map["fruit"] as String).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.map((map) => map["amount"]!).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input
          .map((map) => map["value"] as int)
          .toList(); // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.map((str) => int.parse(str)).toList();
    ...
    () {
      ...
      // Instruksi
      output = input.split(",").map((str) => int.parse(str)).toList();
    ...
    () {
      ...
      // Instruksi
      output = input.split(",").map((str) => str == "true").toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.split(",").map((str) => DateTime.parse(str)).toList();
      // --- End of Answer ---
    ...
    () {
      ...
      // Instruksi
      output = input.split(",").map((str) => double.parse(str)).toList();
    ...
    () {
      ...
      // Instruksi
      Map<String, int>? output = {for (var e in input.split(",")) e: e.length};
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, double>? output = {
        for (var pair in input.split(","))
          pair.split(":")[0]: double.parse(pair.split(":")[1])
      };
    ...
    () {
      ...
      Map<String, bool>? output = {
        for (var pair in input.split(","))
          pair.split(":")[0]: pair.split(":")[1] == "true"
      };
      // --- End of Answer ---
    ...
    () {
      ...
      Map<String, DateTime>? output = {
        for (var pair in input.split(","))
          pair.split(":")[0]: DateTime.parse(pair.split(":")[1])
      };
    ...
    */
    ...
    () {
      ...
      bool? output = input.startsWith('D');
      ;
      return output == true;
    },
    ...
    () {
      ...
      bool? output = input.toString().length == 5;
      return output == true;
    },
    ...
    () {
      ...
      bool? output = input.toString().length == 4;
      return output == false;
    },
    ...
    () {
      ...
      bool? output = input.toString().split('.')[1].length == 2;
      return output == true;
    },
    // Exercise 250
    () {
    ...
    () {
      ...
      bool? output = input.toLowerCase() ==
          input.toLowerCase().split('').reversed.join('');
      return output == false;
    },
    // Exercise 252
    () {
      String input = "Dart is Awesome";
      // Tuliskan kode untuk mengubah input menjadi huruf kecil semua dan memisahkan kata dengan sp
    ...
    () {
      ...
      bool? output = RegExp(r'^[0-9]+$').hasMatch(input);
      return output == true;
    },
    // Exercise 254
    () {
    ...
    () {
      ...
      // Implementasikan kode untuk mengecek apakah semua angka pada List numbers adalah angka gena
      bool? output = numbers.every((number) => number % 2 == 0);
      return output == false;
    },
    // Exercise 257
    () {
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk menggabungkan semua angka pada List numbers menjadi satu string
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      int? total;
      // Implementasikan kode untuk menghitung jumlah total dari semua angka pada List numbers, tap
      int? output = numbers.fold(10, (total, num) => total! + num);
      return output == 25;
    },
    // Exercise 265
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk mengambil setiap angka pada List numbers dan kalikan dengan 2,
      List<int> output = numbers.map((num) => num * 2).toList();
      return output.contains(2) && output.contains(10) && output.length == 5;
    },
    // Exercise 266
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk mengambil setiap angka ganjil pada List numbers, hasilnya disim
      List<int> output = numbers.where((num) => num % 2 != 0).toList();
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk memeriksa apakah semua angka pada List numbers adalah angka pos
    ...
    () {
      ...
      bool? output = numbers.any((num) => num < 0);
      return output;
    },
    // Exercise 271
    () {
    ...
    () {
      List<String> fruits = ["apple", "banana", "cherry"];
      // Implementasikan kode untuk menggabungkan semua elemen pada List fruits menjadi satu string
    ...
    () {
      String text = "Dart is awesome";
      // Implementasikan kode untuk mengubah karakter pertama pada variable text menjadi huruf besa
    ...
    () {
      String text = "Dart is awesome";
      // Implementasikan kode untuk mengubah karakter terakhir pada variable text menjadi huruf bes
    ...
    () {
      String text = "Dart is awesome";
      // Implementasikan kode untuk mengganti kata "awesome" pada variable text dengan kata "fantas
      String? output = text.replaceAll("awesome", "fantastic");
    ...
    () {
      ...
      // Implementasikan kode untuk menggabungkan semua nama pada List names menjadi satu string de
    ...
    () {
      String text = "Dart";
      // Implementasikan kode untuk membalikkan urutan karakter pada variable text, sehingga menjad
    ...
    () {
      List<int> numbers = [1, 2, 3, 4, 5];
      // Implementasikan kode untuk memeriksa apakah semua angka pada List numbers adalah angka pos
      bool? output = numbers.every((number) => number > 0);
      return output;
    },
    // Exercise 284
    () {
    ...
    () {
      String text = "Dart,is,awesome";
      // Implementasikan kode untuk memisahkan kalimat pada variable text berdasarkan tanda koma ("
    ...
    () {
      String text = "Dart is awesome";
      // Implementasikan kode untuk mengambil substring dari index 5 hingga akhir dari variable tex
    ...
    () {
      ...
      int? output = text.replaceAll(RegExp(r'[^aA]'), '').length;
      return output == 2;
    },
    ...
    () {
      ...
      bool? output = numbers.any((number) => number % 2 == 0);
      return output;
    },
    ...
    () {
      ...
      int? output =
          numbers.firstWhere((number) => number % 2 == 0, orElse: () => -1);
      return output == 2;
    },
    ...
    () {
      ...
      int output = numbers.indexWhere((number) => number % 2 == 0);
      return output == 1;
    },
    ...
    () {
      ...
      numbers.removeAt(numbers.indexWhere((number) => number % 2 == 0));
    ...
    () {
      ...
      var output = numbers.sublist(numbers.length - 3);
    ...
    () {
      ...
      numbers.sort();
      return numbers.toString() == '[1, 2, 3, 4, 5, 6, 7, 8]';
    },
    ...
    () {
      ...
      for (var i = 0; i < names.length; i++) {
        ...
        if (i < names.length - 1) {
          concatenatedNames +=
              ","; // Add a comma between names, but not after the last name
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      sortedNumbers = List.from(numbers)..sort((a, b) => b.compareTo(a));
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      users.removeWhere((user) => user["id"] == 3);
      // --- End of Answer ---
    ...
    () {
      ...
      double averageAge = totalAge / employees.length;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["soldInDays"] > maxSoldInDays) {
          // Jika ditemukan soldInDays yang lebih besar, update maxSoldInDays
          maxSoldInDays = products[i]["soldInDays"];
          bestProducts = [
            products[i]["name"]
          ]; // Menyimpan produk dengan soldInDays terbesar
        } else if (products[i]["soldInDays"] == maxSoldInDays) {
          // Jika ada produk lain dengan soldInDays yang sama, tambahkan ke list bestProducts
          bestProducts.add(products[i]["name"]);
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["kpi"] > 80) {
          highPerformers.add(employees[i]);
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      // Looping lagi untuk menambahkan produk dengan soldInDays terbanyak ke dalam bestProducts
      for (int i = 0; i < products.length; i++) {
        if (products[i]["soldInDays"] == maxSoldInDays) {
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["soldInDays"] > maxSoldInDays) {
          maxSoldInDays = products[i]["soldInDays"];
          bestProducts.clear(); // Kosongkan list bestProducts sebelumnya
          bestProducts
              .add(products[i]); // Masukkan produk dengan soldInDays tertinggi
        } else if (products[i]["soldInDays"] == maxSoldInDays) {
          // Jika ada produk lain dengan soldInDays yang sama, tambahkan juga
          bestProducts.add(products[i]);
        }
      }
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["department"] == "HR") {
          hrEmployees.add(employees[i]["name"]);
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["price"] > 200000) {
          expensiveProducts.add(products[i]["name"]);
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["price"] < 300000) {
          affordableProducts.add(products[i]["name"]);
        }
      }
      ["Keyboard", "Mouse"];
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["department"] == "HR") {
          hrEmployee = employees[i]["name"];
          break; // Menghentikan pencarian setelah menemukan karyawan pertama yang bekerja di "HR"
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["price"] > 300000) {
          ...
          break; // Menghentikan pencarian setelah menemukan produk pertama yang sesuai
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["department"] == "IT") {
          itEmployees.add(employees[i]["name"]);
        }
      }
      ["Bob"];
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["age"] > 30 || employees[i]["gender"] == "Female") {
          name = employees[i]["name"];
          age = employees[i]["age"];
          gender = employees[i]["gender"];
          break; // Jika sudah ditemukan, kita hentikan pencarian lebih lanjut
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < products.length; i++) {
        if (products[i]["price"] > 200000 && products[i]["quantitySold"] < 60) {
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["name"].contains("Do")) {
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["name"].split(" ")[0].contains("Jo")) {
          matchedEmployees.add(employees[i]);
        }
      }
      [
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["name"].split(" ").last.contains("son")) {
          matchedEmployees.add(employees[i]);
        }
      }
      ;
    ...
    () {
      ...
      // >>> Tulis kode for loop di sini
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["age"] < 30 && employees[i]["name"].contains("son")) {
          matchedEmployees.add(employees[i]);
        }
      }
      ;
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        String firstName =
            employees[i]["name"].split(" ")[0]; // Mengambil nama depan
    ...
    () {
      ...
      for (int i = 0; i < orders.length; i++) {
        if (orders[i]["id"] == 3) {
          index = i;
          break; // Setelah menemukan order dengan id 3, keluar dari loop
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["name"] == "Eva" && employees[i]["salary"] > 6000) {
          index = i;
          break; // Setelah menemukan employee yang sesuai, keluar dari loop
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < transactions.length; i++) {
        if (transactions[i]["id"] == 5 &&
          ...
          index = i;
          break; // Setelah menemukan transaksi yang sesuai, keluar dari loop
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < products.length; i++) {
        if (products[i]["id"] == 2 && products[i]["price"] == 1200) {
          index = i;
          break; // Setelah menemukan produk yang sesuai, keluar dari loop
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < employees.length; i++) {
        if (employees[i]["name"] == "Bob" && employees[i]["age"] > 30) {
          index = i;
          break; // Setelah menemukan karyawan yang sesuai, keluar dari loop
        }
      }
      ;
      // --- End of Answer ---
    ...
    () {
      ...
      for (int i = 0; i < transactions.length; i++) {
        if (transactions[i]["amount"] == 75 &&
          ...
          index = i;
          break; // Exit the loop after finding the matching transaction
        }
      }
      // --- End of Answer ---
